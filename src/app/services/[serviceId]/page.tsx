...
// Generate static paths for all services (exclude those with dedicated page folders)
const dedicatedPages = ['ai-powered-web-apps', 'custom-ai-agent', 'web-and-graphic-design'];
export async function generateStaticParams() {
  return services
    .filter((service) => !dedicatedPages.includes(service.id))
    .map((service) => ({
  ...
  return (
    <Section>
      ...
      <div className="max-w-xl mx-auto mt-12 px-4">
        <SocialWidget topicId={service.id} />
      </div>
