...
/**
 * @fileOverview An AI agent that answers questions about ChanceTEK's services using RAG.
 *
...
const WebsiteQueryRAGInputSchema = z.object({
  query: z.string().describe('The question to answer about ChanceTEK services.'),
...
const WebsiteQueryRAGOutputSchema = z.object({
  answer: z.string().describe('The answer to the question about ChanceTEK services.'),
});
...
- ChanceTEK's AI Services and Platforms:
  ...
  - ChanceTEK AI Healthcare Platform: A secure, scalable platform built for the future of digital health. It includes ChanceTEK Scribe (AI-assisted clinical documentation), patient tools, and a multi-tenant EHR infrastructure.
  - ChanceTEK AI Marketing Platform: A complete AI-driven marketing suite for dynamic content generation, campaign automation, and real-time analytics.
...
- ChanceTEK Services (Parent Company):
